...
export default function Jobs() {
    return (
       <section id="jobs" className="text-white flex flex-col items-center rounded-xl md:rounded-2xl w-full gap-3 mt-2">
            <h2 className="text-pink-600 text-4xl md:text-5xl font-extrabold tracking-tight bg-black py-12 w-full rounded-xl md:rounded-2xl text-center">
                SWAGAT HAI AAPKA
            </h2>
           ...
           <div className="bg-[#0678F4] text-black flex flex-col sm:flex-row items-center sm:items-center justify-between w-full rounded-xl md:rounded-2xl py-10 px-6 gap-4">
